...
async function destroyAirport(id){
    try {
        ...
        if(error.statusCode == StatusCodes.NOT_FOUND){
            throw new AppError('The airport you wanted to delete is not present', error.statusCode);
        }
...
async function updateAirport(id, data){
    ...
    return response;
        ...
        if(error.statusCode == StatusCodes.NOT_FOUND){
            throw new AppError('The airport you wanted to update is not present', error.statusCode);
        }
